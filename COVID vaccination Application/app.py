...
def action ():  
    #Adding a user 
    SeatNO=request.values.get("SeatNo")  
    classtype=request.values.get("classtype")  
    Availability10Booked=request.values.get("Availability10Booked")
    users.insert({ "SeatNo":SeatNo, 
                   "classtype":classtype, 
                   "Availability10Booked": Availability10Booked, 
                   })  
